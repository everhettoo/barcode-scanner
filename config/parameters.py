...
bar1d_v2_wide_and_high1 = {'gamma': 1,
...
bar1d_v2_wide_and_high2 = {'gamma': 1,
                           'gaussian_ksize': (3, 3),
                           'gaussian_sigma': 1,
                           'min_threshold': 80,
                           'threshold_rate': 0.2,
...
bar1d_v2_wide_and_low1 = {'gamma': 1,
                          'gaussian_ksize': (3, 3),
                          'gaussian_sigma': 1,
                          'min_threshold': 100,
...
bar1d_v2_narrow_and_high1 = {'gamma': 0.8,
                             'gaussian_ksize': (3, 3),
                             'gaussian_sigma': 1,
                             'min_threshold': 80,
                             'threshold_rate': 0.2,
...
"""
The version 1 was experimented to improve qr-code detection based on segmentation using a threshold.
"""
